...
async function kategoriaTele(shop, cfg) {
  ...
  for (const kat of katLista) {
    ...
    for (let page = 1; page <= (shop.kategoria_max_lap || 10); page++) {
      ...
      // Csak akkor lapozunk tovább, ha az ÉPPENI lap is tele van (megfigyelt oldalméret),
      // különben ez az utolsó oldal. Régen fix 40/oldal volt feltételezve, ami a kisebb
      // (pl. 12/lap) ShopRenter-boltoknál az 1. oldal után megállította a gépet.
