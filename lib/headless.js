...
async function headless(termek, shop, cfg) {
  ...
  try {
    ...
    // Kiszerelés-egyeztetés: ha a katalógus-tétel megad méretet (pl. „1 l“),
    // és a találat nevében másképp szerepel a méret (pl. „(0,7l)“), akkor a két
    // termék NEM ugyanaz a kiszerelés → a találatot elutasítjuk, nehogy hamis
    // (1l vs 0,7l) összehasonlítást adjon. Ha bármelyik oldalon ismeretlen a
    // méret, engedjük (nincs miből eldönteni).
